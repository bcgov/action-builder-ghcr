...
> ⚠️ **Moved:** This Action has moved to the centralized [bcgov/actions](https://github.com/bcgov/actions) repository.
> Please update your workflows to use `bcgov/actions/builder-ghcr@v0.2.0` instead.
>
